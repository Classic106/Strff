<template>
  <div class="col">
    <div class="row m-0 p-0 justify-content-between">
      ...
      <p class="m-0" v-show="unknown_orders_count > 0">
        unknown orders: {{ unknown_orders_count }}
      </p>
    </div>
...
export default {
  ...
  methods: {
    ...
    initMarkers: function () {
      ...
      const [unknown_orders_count, markers] = result;

      this.unknown_orders_count = unknown_orders_count;
