<template>
  <div class="col">
    <div class="row m-0 p-0 justify-content-between">
      ...
      <p class="m-0" v-show="unknown_products_count > 0">
        unknown products: {{ unknown_products_count }}
      </p>
    </div>
...
export default {
  ...
  methods: {
    ...
    initMarkers: function () {
      ...
      const [unknown_products_count, markers] = result;

      this.unknown_products_count = unknown_products_count;
